...
\hypersetup{
  pdftitle={Good practices in bioinformatic or computational biology projects},
  pdfauthor={Yang Cao},
  hidelinks,
...
\addcontentsline{toc}{section}{Project Organization}
...
\addcontentsline{toc}{section}{Code style}
...
\addcontentsline{toc}{part}{Code Style}
...
\addcontentsline{toc}{part}{Practical Skills in action}
...
\addcontentsline{toc}{paragraph}{Use local registry}
...
\textbf{Note} To use local registry: you should set
\texttt{docker.hash-lookup.enabled\ =\ false} see
\href{https://github.com/broadinstitute/cromwell/issues/6172}{this issue}.
...
\addcontentsline{toc}{paragraph}{volume host path to the container}
...
\addcontentsline{toc}{subsubsection}{Expression support}
...
\addcontentsline{toc}{subsubsection}{disks}
...
\addcontentsline{toc}{subsubsection}{continueOnReturnCode}
